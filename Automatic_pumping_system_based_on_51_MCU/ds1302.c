...
//---DS1302时钟初始化2018年1月2日星期二22点00分00秒。---//
//---存储顺序是秒分时日月周年,存储格式是用BCD码---//
uchar TIME[7] = {0, 0, 0x22, 0x02, 0x01, 0x02, 0x18};
...
void ShowWeek(void)
{
	uchar week = TIME[5]&0x07;
	switch(week)
	{
		case 1: LCD12864_ShowString(0,3,"一");break;
		case 2: LCD12864_ShowString(0,3,"二");break;
		case 3: LCD12864_ShowString(0,3,"三");break;
		case 4: LCD12864_ShowString(0,3,"四");break;
		case 5: LCD12864_ShowString(0,3,"五");break;
		case 6: LCD12864_ShowString(0,3,"六");break;
		case 0: LCD12864_ShowString(0,3,"日");break;
	}
}